# How to contribute to Cozy video?
...
- What is the version of the Cozy Cozy video?
...
```
$ git clone github.com/Asuuga/cozy-video.git
$ cd cozy-video
$ git remote add fork git://github.com/yourusername/cozy-video.git
```
...
Go to https://github.com/yourusername/cozy-video and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy video is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/Asuuga/cozy-video/issues/new
...
[localization]: https://github.com/Asuuga/cozy-video/blob/master/README.md#localization
