[![Travis build status shield](https://img.shields.io/travis/Asuuga/cozy-video/master.svg)](https://travis-ci.org/Asuuga/cozy-video)
[![Github Release version shield](https://img.shields.io/github/tag/Asuuga/cozy-video.svg)](https://github.com/Asuuga/cozy-video/releases)
...
Hacking the Cozy Cozy video app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/Asuuga/cozy-video.git
$ cd cozy-video
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://cozy-video.cozy.tools:8080.
...
If you want to work on Cozy video and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy video is [Asuuga](https://github.com/Asuuga), send him/her a :beers: to say hello!
...
Cozy video is developed by Asuuga and distributed under the [AGPL v3 license][agpl-3.0].
